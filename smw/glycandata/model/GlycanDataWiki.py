...
class Annotation(SMW.SMWClass):
	...
	if data.get('type') in ['CrossReference','Motif','Taxonomy','Publication','Enzyme','Name'] or \
           data.get('property') in ['Compositions','Topologies','Saccharides','SubsumedBy','Subsumes','Ancestor','Descendant','Human Evidence','Mouse Evidence','Rat Evidence','HCV Evidence']:
